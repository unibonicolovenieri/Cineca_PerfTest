...
# Naviga alla cartella dove c'è il programma MPI (modifica il percorso)
cd /home/nvenieri/VectorSum/MPIscripts  # Modifica con il percorso corretto

# Compila il programma MPI
mpicc -o mpi_vector_sum mpi_vector_sum.c

# Crea un file per l'output di perf
PERF_OUTPUT="logs/perf_outputs.txt"
...
# Esegui il comando perf
echo "Running perf command..." >> $PERF_OUTPUT
